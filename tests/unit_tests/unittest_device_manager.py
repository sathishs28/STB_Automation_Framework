...
"""
    ...
    @patch("builtins.open", return_value=io.StringIO(fake_yaml))
    @patch("backends.ir_backend.IRBackend")
    def test_startup_loads_correct_device(self, mock_backend, mock_open):
    ...
    @patch("builtins.open", return_value=io.StringIO(fake_yaml))
    def test_health_check_fails_when_disconnected(self, mock_open):
        from core.device_manager import Device_Manager
